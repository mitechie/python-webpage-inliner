...
You will need to also install BeautifulSoup (http://www.crummy.com/software/BeautifulSoup/)
and feedparser (http://www.feedparser.org/) which are used to parse the HTML markup and
character set detection respectively.
...
Download the page and pass it through the inliner like this:
	...
	python inliner.py index.html index-inlined.html
